...
//                });
                ...
                String param="PartnersUsername=" + URLEncoder.encode(mEmail,"UTF-8")+ "&PartnersPassword="+URLEncoder.encode(mPassword,"UTF-8");
            ...
            Log.v("Authentication", "Authentication finished now " + mEmail + ":" + mPassword );
            return true;
        }
