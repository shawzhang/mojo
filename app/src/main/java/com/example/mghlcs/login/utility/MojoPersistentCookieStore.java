...
public class MojoPersistentCookieStore implements CookieStore {
    ...
    private static MojoPersistentCookieStore instance; // Singleton
    ...
    public MojoPersistentCookieStore(Context ctxContext) {
    ...
    private MojoPersistentCookieStore(Context ctxContenxt, String prefix) {
        this(ctxContenxt);
     ...
     * @return new instance.
     */
    public static MojoPersistentCookieStore getInstance(Context ctx) {
        if (instance == null) {
            instance = new MojoPersistentCookieStore(ctx);
        }
        return instance;
    }
     ...
     * @return new instance.
     */
    public static MojoPersistentCookieStore getInstance(Context ctx, String prefix) {
        if (instance == null) {
            instance = new MojoPersistentCookieStore(ctx);
        }
        return instance;
